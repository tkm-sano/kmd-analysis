...
def main():
    ...
    planned = {
        ...
        "scientific_parameters": {"routing_baseline": "frozen", "qubo_formulation": "R20/R21/R22 reduced route-ordering authority", "encoding": "frozen authority encoding", "qaoa_ansatz": "frozen R23 implementation", "parameter_order": "[gamma_1..gamma_p, beta_1..beta_p]", "backend": "exact CPU Qiskit Aer statevector", "shots": "NONE", "transpiler_settings": {"optimization_level": 1, "seed_transpiler": 17}, "simulator_seed": 17, "probability_semantics": "exact statevector probability mass", "invalid_bitstring_handling": "frozen implementation semantics", "exact_route_comparison": "frozen exact-reference semantics", "runtime_semantics": "frozen R23 timing semantics"},
    ...
    decision = {
        ...
        "authorized_optimizer": None, "proposed_optimizer": {"name": "NELDER_MEAD", "method": "Nelder-Mead", "maxiter": 300, "common_objective_evaluation_cap": 900, "stopping_tolerances": "UNFROZEN", "optimizer_specific_options": "UNFROZEN", "parameter_order": "[gamma_1..gamma_p, beta_1..beta_p]"},
        ...
        "scientific_parameters_unchanged": True, "scientific_parameters": planned["scientific_parameters"], "runtime_policy": {"wall_time": "NO_RESEARCH_WALL_TIME_CAP", "fairness_basis": "common objective evaluations", "objective_evaluation_cap": 900},
