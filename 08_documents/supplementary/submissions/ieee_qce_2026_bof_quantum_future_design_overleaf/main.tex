...
\bibitem{quantum_future_society_vision}
Council for Integrated Innovation Strategy, ``Quantum future society vision,'' Apr. 22, 2022.

\bibitem{darpa_qbi}
Defense Advanced Research Projects Agency, ``Quantum Benchmarking Initiative expands quest to separate hype from reality,'' Mar. 10, 2026.

\bibitem{johnson_sfp}
B. D. Johnson, ``When science fiction and science fact meet,'' \emph{Computer}, vol. 46, no. 1, pp. 80--82, Jan. 2013, doi: 10.1109/MC.2013.35.

\bibitem{burnam_fink}
M. Burnam-Fink, ``Creating narrative scenarios: Science fiction prototyping at Emerge,'' \emph{Futures}, vol. 70, pp. 48--55, Jun. 2015, doi: 10.1016/j.futures.2014.12.005.

\bibitem{draudt}
A. Draudt, J. Hadley, R. Hogan, L. Murray, G. Stock, and J. R. West, ``Six insights about science fiction prototyping,'' \emph{Computer}, vol. 48, no. 5, pp. 69--71, May 2015, doi: 10.1109/MC.2015.142.

\bibitem{zappin}
J. Zappin, T. Stalnaker, O. Chaparro, and D. Poshyvanyk, ``Bridging the quantum divide: Aligning academic and industry goals in software engineering,'' in \emph{Proc. 2025 IEEE/ACM 6th International Workshop on Quantum Software Engineering (Q-SE)}, 2025, pp. 43--47, doi: 10.1109/Q-SE66736.2025.00013.
\end{thebibliography}
