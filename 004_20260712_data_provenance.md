...
Processing lineage is captured by `010_20260712_code_data_dependency_map.csv`. Renaming and final source URLs are recorded in the renaming map and reference inventory.
