...
def build_search_performance(compute_df: pd.DataFrame, config_path: Path, search_multiplier: float = 1.0) -> pd.DataFrame:
    ...
    df["search_performance_index"] = df["search_performance_index"] * search_multiplier
    panel = (
