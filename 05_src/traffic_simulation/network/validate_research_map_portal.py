...
def main():
    ...
    assert m['current_position']['previous_milestone']=='formal_network_acceptance'
    ...
    assert all(by_id[x]['status']=='COMPLETE' for x in ['formal_completion','sumo_materialization','network_validation','stop_mapping','routeability','formal_network_acceptance'])
