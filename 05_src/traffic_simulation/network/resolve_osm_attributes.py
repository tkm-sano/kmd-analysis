...
def load_policy(
    ...
    """Load and strictly validate the v9 resolver policy."""
    ...
    if config.get("config_version") != 9:
        raise ValueError("resolve_osm_attributes requires sumo_network config v9")
    ...
    if oneway.get("explicit_reverse") != (
        ...
        raise ValueError("reverse oneway must fail closed in config v9")
