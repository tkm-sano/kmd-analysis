...
| `OSM Expressway / trunk` | 高速道路・自動車専用道路等 |
| `OSM Primary / secondary` | 主要幹線道路 |
| `OSM Tertiary / unclassified` | 補助幹線・未分類道路 |
| `OSM Residential / living street` | 住宅道路。初期状態では非表示 |
| `OSM Service / other motor road` | 構内・サービス道路等。初期状態では非表示 |
| `OSM traffic signals` | OSMに登録された信号位置。初期状態では非表示 |
...
| 表示対象 | 件数 |
|---|---:|
| Expressway / trunk | 973 |
| Primary / secondary | 957 |
| Tertiary / unclassified | 6,267 |
| Residential / living street | 5,543 |
| Service / other motor road | 12,461 |
| 自動車道路候補合計 | 26,201 |
| OSM traffic signals | 2,190 |
| JARTIC観測地点 | 33 |
