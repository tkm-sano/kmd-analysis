...
Document ID: `DOC-RESEARCH-OVERVIEW-V17`
Role: `PRIMARY_ENTRY`
Lifecycle: `CURRENT`
Created: `2026-09-03`
...
`20260903_20260903_RESEARCH_OVERVIEW.md` is the dated canonical document. `RESEARCH_OVERVIEW.md` is a content-free stable pointer retained for GitHub, Portal, CLI, and external-link compatibility; this avoids duplicate maintenance while exposing creation and update dates in the canonical filename. No other current Stage 1–11 roadmap was found. `RESEARCH_STATUS.md` is an older generated dashboard with a different, narrower 21-step source taxonomy; dated project-management documents remain historical design/status records rather than parallel current roadmaps.
...
- Human navigation map: [dated research repository map v17](reproducibility/indexes/20260903_20260903_research_repository_map_v17.md)
- Repository inventory description: [research_repository_inventory_v17.md](reproducibility/indexes/research_repository_inventory_v17.md); machine-readable inventory: [`markdown_inventory_v17.yml`](reproducibility/indexes/markdown_inventory_v17.yml)
- Portal stage graph: [research_map_v1.yml](reproducibility/config/research_portal/research_map_v1.yml)
- Unified research CLI: [dated research CLI reference](docs/20260903_20260903_research_cli.md) (`./research commands` is the canonical command index)
